...
static const char * const power_supply_health_text[] = {
	...
	"Dual-engine", "Vivo Super Flash Charge"
};
...
static ssize_t power_supply_show_property(struct device *dev,
	...
	case POWER_SUPPLY_PROP_CHARGE_COUNTER_EXT:
		ret = sprintf(buf, "%lld\n", value.int64val);
		break;
	case POWER_SUPPLY_PROP_MODEL_NAME ... POWER_SUPPLY_PROP_DEBUG_INFO:	//vivo_chg change
		ret = sprintf(buf, "%s\n", value.strval);
		break;
	default:
		ret = sprintf(buf, "%d\n", value.intval);
...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(live_state),
	POWER_SUPPLY_ATTR(camera_state),
	...
	POWER_SUPPLY_ATTR(ffc_charge_full),
	//POWER_SUPPLY_ATTR(fg_reset),
	...
	POWER_SUPPLY_ATTR(board_temp_state),
	POWER_SUPPLY_ATTR(bat_fcc),
	POWER_SUPPLY_ATTR(bat_rm),
	...
	POWER_SUPPLY_ATTR(wpc_debug),
	POWER_SUPPLY_ATTR(wpc_chg_mode),
	POWER_SUPPLY_ATTR(factory_test_mode),
	POWER_SUPPLY_ATTR(device_move),
	POWER_SUPPLY_ATTR(charging_technology),
	POWER_SUPPLY_ATTR(force_usb_icl),
	POWER_SUPPLY_ATTR(scene_recognition),
	...
	POWER_SUPPLY_ATTR(fg_info),
	POWER_SUPPLY_ATTR(debug_info),
};
