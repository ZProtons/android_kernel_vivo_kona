...
int security_load_policy(struct selinux_state *state, void *data, size_t len)
{
	...
	/*Klocwork:Possible memory leak. Dynamic memory stored in 'newsidtab.htable'
	 allocated through function 'policydb_load_isids' at line 2335 can be lost at line 2478
	 */
	memset(&newsidtab, 0, sizeof(newsidtab));
