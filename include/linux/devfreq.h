...
//pengmingming add for requesting ddr bandwidth start
#if defined(CONFIG_DDR_BW_REQUEST)
extern int ddr_bw_enable(void);
extern void ddr_bw_disable(void);
#else
static inline int ddr_bw_enable(void)
{
	return -EINVAL;
}
static inline void ddr_bw_disable(void)
{
}
#endif
//pengmingming add for requesting ddr bandwidth end
