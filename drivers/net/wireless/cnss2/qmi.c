...
#define MAX_BDF_FILE_NAME		20
#define BDF_FILE_NAME_PREFIX		"bdwlan"
#define ELF_BDF_FILE_NAME		"bdwlan.elf"
#define CHAIN0_ELF_BDF_FILE_NAME	"bdwlan0.elf"
#define CHAIN1_ELF_BDF_FILE_NAME	"bdwlan1.elf"
#define PD1955_4G_ELF_BDF_FILE_NAME		"bdwlan_4g.elf"
#define PD1955_4G_CHAIN0_ELF_BDF_FILE_NAME	"bdwlan0_4g.elf"
#define PD1955_4G_CHAIN1_ELF_BDF_FILE_NAME	"bdwlan1_4g.elf"
#define PD1950_0111_ELF_BDF_FILE_NAME		"bdwlan_0111.elf"
#define PD1950_0111_CHAIN0_ELF_BDF_FILE_NAME	"bdwlan0_0111.elf"
#define PD1950_0111_CHAIN1_ELF_BDF_FILE_NAME	"bdwlan1_0111.elf"
// vivo lanyonghui add for compatible with PD2024 and PD2025 begin.
#define PD2025_ELF_BDF_FILE_NAME		"bdwlan_pd2025.elf"
#define PD2025_CHAIN0_ELF_BDF_FILE_NAME		"bdwlan0_pd2025.elf"
#define PD2025_CHAIN1_ELF_BDF_FILE_NAME		"bdwlan1_pd2025.elf"
// vivo lanyonghui add for compatible with PD2024 and PD2025 end.
				  ...
				  u32 filename_len)
{
	...
	cnss_pr_err("fix_chain=%s\n", fix_chain);

	switch (bdf_type) {
	case CNSS_BDF_ELF:
		if (plat_priv->board_info.board_id == 0xFF) {
			if (!strncmp(fix_chain, "chain0", strlen("chain0"))) {
				if (project_name != NULL && (!strncmp(project_name, "PD1955F_EX", strlen("PD1955F_EX"))) && board_version != NULL && board_version[0] == '0') {
					snprintf(filename_tmp, filename_len, PD1955_4G_CHAIN0_ELF_BDF_FILE_NAME);
				} else if (project_name != NULL && (!strncmp(project_name, "PD1950", strlen("PD1950"))) && board_version != NULL && (!strncmp(board_version, "0111", strlen("0111")))) {
					snprintf(filename_tmp, filename_len, PD1950_0111_CHAIN0_ELF_BDF_FILE_NAME);
				} else if (project_name != NULL && (!strncmp(project_name, "PD2024", strlen("PD2024"))) && board_version != NULL && board_version[0] == '0') {
					snprintf(filename_tmp, filename_len, PD2025_CHAIN0_ELF_BDF_FILE_NAME);
				} else {
					snprintf(filename_tmp, filename_len, CHAIN0_ELF_BDF_FILE_NAME);
				}
			} else if (!strncmp(fix_chain, "chain1", strlen("chain1"))) {
				if (project_name != NULL && (!strncmp(project_name, "PD1955F_EX", strlen("PD1955F_EX"))) && board_version != NULL && board_version[0] == '0') {
					snprintf(filename_tmp, filename_len, PD1955_4G_CHAIN1_ELF_BDF_FILE_NAME);
				} else if (project_name != NULL && (!strncmp(project_name, "PD1950", strlen("PD1950"))) && board_version != NULL && (!strncmp(board_version, "0111", strlen("0111")))) {
					snprintf(filename_tmp, filename_len, PD1950_0111_CHAIN1_ELF_BDF_FILE_NAME);
				} else if (project_name != NULL && (!strncmp(project_name, "PD2024", strlen("PD2024"))) && board_version != NULL && board_version[0] == '0') {
					snprintf(filename_tmp, filename_len, PD2025_CHAIN1_ELF_BDF_FILE_NAME);
				} else {
					snprintf(filename_tmp, filename_len, CHAIN1_ELF_BDF_FILE_NAME);
				}
			} else {
				if (project_name != NULL && (!strncmp(project_name, "PD1955F_EX", strlen("PD1955F_EX"))) && board_version != NULL && board_version[0] == '0') {
					snprintf(filename_tmp, filename_len, PD1955_4G_ELF_BDF_FILE_NAME);
				} else if (project_name != NULL && (!strncmp(project_name, "PD1950", strlen("PD1950"))) && board_version != NULL && (!strncmp(board_version, "0111", strlen("0111")))) {
					snprintf(filename_tmp, filename_len, PD1950_0111_ELF_BDF_FILE_NAME);
				} else if (project_name != NULL && (!strncmp(project_name, "PD2024", strlen("PD2024"))) && board_version != NULL && board_version[0] == '0') {
					snprintf(filename_tmp, filename_len, PD2025_ELF_BDF_FILE_NAME);
				} else {
