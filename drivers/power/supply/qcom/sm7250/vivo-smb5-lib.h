...
struct smb_charger {
	...
	unsigned long last_dischg_change_record_tm;
	unsigned long last_chg_drop_change_record_tm;
	bool chg_less_than_consume;
	int last_qg_monitor_work_count;
	int ui_soc_delta_qg_cnt;
	bool tracking_dischg_enable;
	int tracking_dischg_step_second;
	int tracking_dischg_step_cnt;
	int tracking_dischg_current_threshold;
	int tracking_dischg_volt_threshold;
	int tracking_dischg_low_volt_step_second;
	int tracking_dischg_delta_soc;
	...
	int ffc_fv_max_uv;
	int ffc_fv_max_uv_sec;
	struct ffc_full_chg_ibat_table *ffc_full_chg_ibat_table;
	struct ffc_full_chg_ibat_table *ffc_full_chg_ibat_table_sec;
	struct ffc_full_chg_ibat_table *ffc_full_chg_ibat_table_third;
	bool multiple_ffc_full_chg_ibat_table_config;
	int *multiple_batid;
	int *ffc_full_chg_ibat_rc;
	int ffc_full_chg_iterm_delta_ma;
	int *ffc_full_chg_vbat_table;
	int *ffc_full_chg_vbat_table_sec;
	int ffc_temperature_range[2];
	int ffc_param_tuning_enable;
	bool is_high_volt_battery;
