...
struct ufs_hba {
	...
	struct device_attribute irq_affinity_attr;
#endif
...
#define UFSHCD_CAP_CRYPTO (1 << 7)
	...
	bool force_g4;
	bool wb_enabled;
	bool wb_h8_buf_flush_enabled;
	int wb_h8_buf_flush_count_thr;
	int wb_h8_buf_flush_count_usb;
	enum wb_flush_reason wb_h8_buf_flush_reason;
