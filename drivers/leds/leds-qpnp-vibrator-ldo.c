...
/*Added by vsen team, for  haptic printf pid start*/
#include <linux/sched.h>
#include <linux/smp.h>
#include <linux/export.h>
#include <asm/ptrace.h>
/*Added by vsen team, for haptic printf pid end*/
