...
int vivoTsSendReportAbs(void)
{
	if (vivoTsData->sendScreenReportCmd)
		return vivoTsData->sendScreenReportCmd();
	else
		return -FUN_NOT_REG;
}
/*
...
int vivoClearScreenClockCmd(void)
{
	int ret = 0 ;
