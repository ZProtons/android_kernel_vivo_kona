...
struct smb_charger {
	...
	//LCM ?y?¡¥IC¡ê??¨²?¨²3????1o¨®¡ê??¨¢3???¨¦¨¢?¨¢?¨º¨¬a¡êo???¨®¨°???GPIO¡ê?¨¤-??GPIO???¨®LCM?y?¡¥IC?o??¡ê?1?¡À¨¹¨¦¨¢?¨¢?¡ê
	...
	int lcm_consume_mos_gpio_control_error_count;	//??¡ä¨®¨ºy?Y¡ê???¨¤-???¡é¦Ì¨ª¡ê?¨¨¡ä¨¤-2????¡é¦Ì¨ª?¡ê lcm_consume_mos_gpio_setting_value != lcm_consume_mos_gpio_read_value
