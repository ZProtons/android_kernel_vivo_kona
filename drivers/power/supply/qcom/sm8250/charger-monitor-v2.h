...
#define DCHG_HEAVY_LOAD_EVENT	"DCHG_HEAVY_LOAD_EVENT"
...
static const char* const dchg_status_strings[] = {
	"DIRECT_CHARGER_UNKNOW",
	"DIRECT_CHARGER_PREPARE",
	"DIRECT_CHARGER_IS_CHARGERING",
	"DIRECT_CHARGER_END",
};
