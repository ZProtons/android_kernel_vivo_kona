...
struct swap_info_struct {
	...
	time64_t *swap_timestamp;	/* correspond to swap_map */
#endif
...
#ifdef CONFIG_MEM_BIGDATA
extern struct swap_cluster_info *mbd_lock_cluster(struct swap_info_struct *, unsigned long);
extern void mbd_unlock_cluster(struct swap_cluster_info *ci);
#endif
