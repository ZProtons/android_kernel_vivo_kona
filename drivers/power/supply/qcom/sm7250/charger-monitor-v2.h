...
#define LIVE_EVENT		"LIVE_EVENT"
#define CAMERA_EVENT		"CAMERA_EVENT"
...
struct cms{
	...
	bool live_scale_enable;
	bool live_state;
	int *live_scale_data;
	bool live_dchg_disable;
	...
	bool camera_scale_enable;
	bool camera_state;
	int *camera_scale_data;
	...
	bool dual_normal_config;
	int sec_normal_data_id;
	int *normal_tc_rc_sec;
	struct tc_data_item_ex *normal_tc_data_sec;
	...
	bool scene_recognition_enable;
	int intell_scene;
	int *primary_scene_1_tc_rc;
	struct tc_data_item *primary_scene_1_tc_data;
	int *parallel_scene_1_tc_rc;
	struct tc_data_item *parallel_scene_1_tc_data;
	int *primary_scene_2_tc_rc;
	struct tc_data_item *primary_scene_2_tc_data;
	int *parallel_scene_2_tc_rc;
	struct tc_data_item *parallel_scene_2_tc_data;
	int *primary_scene_3_tc_rc;
	struct tc_data_item *primary_scene_3_tc_data;
	int *parallel_scene_3_tc_rc;
	struct tc_data_item *parallel_scene_3_tc_data;
...
static struct tc_data_item default_scene_tc_data[] = {
	{
		.min	= 471,
		.max	= 8888,
		.data	= 0,
...
* 5V2A charge min current threshold: 500mA,5V2A charge max current threshold:2100mA,
* flash charge min current threshold:3000mA,flash charge max current threshold:8100mA
* bypass 11V5A: min current threshold:default 0mA, max current threshold:default 0mA
*/
static int default_charge_param_judge_threshold[] = {5, 2, 3500, 4100, 500, 2100, 3000, 8100, 0, 0};
